...
const travelerModes = [
  {
    ...
    body: 'Start with the main route anchors. These are the cities that can carry a first trip without forcing frantic movement.',
    href: '/route-1',
    cta: 'Open Anchors',
  },
  {
    ...
    body: 'Move through junctions and anchor chapters when the route should get richer through slower pacing, repeat meals, and deeper neighborhood curiosity.',
    href: '/route-1',
    cta: 'Open Hubs',
  },
  {
    ...
    body: 'Use pause and scenic stops for texture, atmosphere, and smaller cities that only make sense when you stop optimizing every hour.',
    href: '/updated-cities',
    cta: 'Open Detours',
  },
];
