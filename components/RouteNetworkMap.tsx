        ...
        <div className="overflow-hidden rounded-[2.25rem] border border-stone-200/80 bg-white/80 shadow-[0_30px_90px_rgba(34,30,25,0.08)] backdrop-blur">
          <div className="border-b border-stone-200 px-6 py-5 md:px-8">
            ...
            <p className="mt-4 max-w-3xl text-sm leading-7 text-stone-600 md:text-base">
              ...
              that shape that journey, including junctions where one trip can branch into another.
            </p>
          ...
          <div className="grid gap-0 lg:grid-cols-[minmax(0,1.55fr)_minmax(22rem,0.8fr)]">
            <div className="relative h-[32rem] bg-stone-100 md:h-[38rem] lg:h-[calc(100vh-9rem)] lg:min-h-[40rem] lg:max-h-[48rem]">
            ...
            <div className="bg-[#171411] p-5 text-white md:p-6 lg:max-h-[48rem] lg:overflow-y-auto">
                ...
                {routeNetworkRoutes.map((route) => {
                  ...
                  return (
                    <button
                      ...
                      className={`rounded-[1rem] border px-4 py-3 text-left transition-all duration-300 ${
                        isExpanded
                    ...
                    >
                      <div className="flex items-center justify-between gap-3">
                        <div className="min-w-0">
                          ...
                          <h3 className="mt-1 truncate font-serif text-xl leading-tight text-white">
                            {route.title}
                          </h3>
                        </div>
                        <span
                  ...
                  <div className="mt-4 grid gap-2">
                    {expandedRouteCities.map((city) => (
                      <Link
                        ...
                        href={city.href}
                        className="flex items-center justify-between gap-3 rounded-[0.9rem] border border-white/10 bg-black/15 px-3 py-2.5 text-sm text-stone-200 transition-colors hover:border-white/24 hover:bg-white/8"
                      >
                        <span>{city.name}</span>
                        <span
                          className={`shrink-0 rounded-full border px-2 py-1 text-[9px] font-semibold uppercase tracking-[0.18em] ${getKindChipClass(
                            city.kind
                          )}`}
                        >
