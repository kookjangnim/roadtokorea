  ...
  return (
    <section className="relative overflow-hidden bg-[#16130f] px-4 pb-8 pt-6 text-white md:px-8 md:pb-12 md:pt-8">
      ...
      <div className="relative mx-auto grid max-w-7xl gap-5 lg:grid-cols-[minmax(0,0.88fr)_minmax(0,1.12fr)]">
        <div className="flex flex-col justify-between gap-8 py-4 lg:min-h-[calc(100vh-5rem)] lg:max-h-[54rem] lg:py-8">
          <div>
            <span className="inline-flex w-fit border border-white/[0.15] bg-white/[0.08] px-4 py-2 text-[11px] font-semibold uppercase tracking-[0.34em] text-stone-200 backdrop-blur">
              Terrain-first Korea
            </span>
            <h1 className="mt-6 max-w-3xl font-serif text-4xl leading-[0.96] text-white sm:text-5xl md:text-7xl">
          ...
          <div className="hidden border border-white/[0.12] bg-black/[0.28] p-5 backdrop-blur-md md:p-6 lg:block">
            ...
            <p className="mt-3 text-sm leading-7 text-stone-400">{activeScene.terrain}</p>
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <Link
                ...
                className="bg-white px-5 py-3 text-xs font-semibold uppercase tracking-[0.24em] text-stone-950 transition-transform duration-300 hover:-translate-y-0.5"
              >
                Open Route
              </Link>
              <Link
                href="#how-it-works"
                className="border border-white/[0.18] px-5 py-3 text-xs font-semibold uppercase tracking-[0.24em] text-stone-200 transition-colors hover:border-white/[0.34] hover:bg-white/[0.08]"
              >
                How it works
              </Link>
            </div>
