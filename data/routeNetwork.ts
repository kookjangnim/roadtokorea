...
export const routeNetworkCities: Record<string, RouteNetworkCity> = {
  ...
  jeongseon: { slug: 'jeongseon', name: 'Jeongseon', kind: 'branch', x: 68, y: 36, lat: 37.3806, lng: 128.6609, href: '/route-2/branch-a' },
  taebaek: { slug: 'taebaek', name: 'Taebaek', kind: 'branch', x: 75, y: 43, lat: 37.1641, lng: 128.9856, href: '/route-2/branch-a' },
